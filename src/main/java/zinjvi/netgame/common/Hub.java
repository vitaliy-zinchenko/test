...
public class Hub {
     ...
     * @throws java.io.IOException if it is not possible to create a listening socket on the specified port.
     */
     ...
     * @throws java.io.IOException should be thrown if some error occurs that should
     ...
     * @throws java.io.IOException if it is impossible to create a listening socket on the specified port.
     */
